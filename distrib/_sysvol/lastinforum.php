...
{
 $ipb_mysql_data_base_name="forum";  //имя базы данных форму IPB
 $ipb_mysql_host="localhost"; //адрес MySQL для форума IPB
 $ipb_mysql_user="root"; //пользователь для MySQL, на которой стоит база IPB
...
if(!$ntime || (time()-$ntime >3600)) //раз в час обновляет данные с форума
{
 ob_start();
 echo lasttopicipb();
